<?php
/**
 * Listing Card Template (Grid View).
 *
...
<article <?php post_class( $card_classes, $listing_id ); ?>>
	...
	<div class="apd-listing-card__footer">
		<?php
		/**
		 * Fires inside the card footer.
		 *
		 * Use this to add favorites button, view count, etc.
		 *
		 * @since 1.0.0
		 *
		 * @param int $listing_id The listing post ID.
