 ...
 * Checkbox Field Type.
 *
 * Single boolean checkbox input for yes/no values.
 *
 ...
 * Class CheckboxField
 *
 * Handles rendering and processing of single checkbox inputs.
 *
 * @since 1.0.0
 */
class CheckboxField extends AbstractFieldType {
	...
	public function render( array $field, mixed $value ): string {
		...
		$html .= ' <span class="apd-checkbox-text">' . esc_html( $label ) . '</span>';
		$html .= '</label>';
	 ...
	 *
	 * Checkbox validation always passes (boolean value is always valid).
	 * Required check handles whether checked is mandatory.
	 *
	 * @since 1.0.0
	 *
	...
	public function validate( mixed $value, array $field ): bool|WP_Error {
		// Check required - for checkbox, required means it must be checked.
	 ...
	 * @since 1.0.0
	 *
	 * @return bool False as default (unchecked).
	 */
	 ...
	 *
	 * Returns Yes/No or custom labels from config.
	 *
	 * @since 1.0.0
	 *
	 ...
	 *
	 * For checkbox, false is not considered empty (it's a valid state).
	 *
	 * @since 1.0.0
	 *
